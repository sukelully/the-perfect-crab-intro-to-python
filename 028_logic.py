...
# The `if` keyword looks at whether the conditional expression evaluates to True
# or False to decide whether to execute its block, or the else block.

# We can use this information to combine conditions using a new kind of
...
# @TASK: Research by searching the web for "python logical operators" and
